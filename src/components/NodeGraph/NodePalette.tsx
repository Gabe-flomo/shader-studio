...
const EXAMPLE_FOLDERS: Array<{ label: string; color: string; keys: ExKey[] }> = [
  ...
  { label: '3D SDF',          color: '#89dceb', keys: ['sdfBooleanShowcase','sdfOnionShell','sdfPrimitivesShowcase','sdfPolarRepeat','sdfSmoothMetaballs','sdfRoundedBox','sdfBoxFrame','sdfCappedCone','sdfHexPrism','sdfBend3D','sdfIntersectDemo','mengerSponge3D','sdCrossScene3D','infinitePillars3D','spiralWorld3D','sphereInversion3D','kaleidoscopeBox3D','icoKaleidoscope3D','mobiusWarp3D','logPolarZoom3D','helixWarp3D','shearKaleidoscope3D','mobiusInversionStack3D'] as ExKey[] },
