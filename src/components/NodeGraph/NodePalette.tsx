...
const EXAMPLE_FOLDERS: Array<{ label: string; color: string; keys: ExKey[] }> = [
  ...
  { label: 'Grid',            color: '#89dceb', keys: ['gridBasic','gridCircles','gridWave','gridNeighborDots','gridNeighborDisplaced','grid3dSpheres','grid3dWave','grid3dNeighbor','grid3dScatter'] as ExKey[] },
