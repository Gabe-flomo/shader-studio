...
const EXAMPLE_FOLDERS: Array<{ label: string; color: string; keys: ExKey[] }> = [
  ...
  { label: 'Post Effects',    color: '#f38ba8', keys: ['vignetteDemo','scanlinesDemo','sobelDemo','sobelGlow','gaussianBlurDemo','motionBlurTrails','tiltShiftScene','lensBokeh'] as ExKey[] },
