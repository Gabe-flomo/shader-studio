...
const EXAMPLE_FOLDERS: Array<{ label: string; color: string; keys: ExKey[] }> = [
  ...
  { label: 'March Loop',      color: '#88aacc', keys: ['mlgOctaField','mlgTwistColumn','mlgSinBend','mlgFoldCrystal','mlgSpiralTunnel','mlgLayeredWarp','mlgTwistFold','mlgSinSpiral'] as ExKey[] },
