...
export const WeightedAverageNode: NodeDefinition = {
  ...
  paramDefs: {
    ...
    w3:          { label: 'W3',          type: 'float',  min: 0.0, max: 10.0, step: 0.1, showWhen: { param: 'inputs_used', value: ['3', '4'] } },
    w4:          { label: 'W4',          type: 'float',  min: 0.0, max: 10.0, step: 0.1, showWhen: { param: 'inputs_used', value: '4' } },
