  ...
  tiltShiftScene: {
    ...
    nodes: [
      ...
      },
      {
        ...
        params: { octaves: 6, lacunarity: 2, gain: 0.5, scale: 2, time_scale: 0.03 },
      },
      {
        id: 'ts_pal',
        type: 'palettePreset',
      ...
      },
      {
        ...
        params: { focus_center: 0, band_width: 0.2, max_blur: 8, tilt_angle: 12, axis: 'horizontal' },
      },
      {
        id: 'ts_out',
        type: 'output',
  ...
  matrixColorGrade: {
    ...
    nodes: [
      ...
      },
      {
        ...
        inputs: {
          r: { type: 'float', label: 'R', connection: { nodeId: 'cos_3', outputKey: 'output' } },
          g: { type: 'float', label: 'G', connection: { nodeId: 'sin_4', outputKey: 'output' } },
          b: { type: 'float', label: 'B', connection: { nodeId: 'zero_6', outputKey: 'value' } },
        },
        outputs: { rgb: { type: 'vec3', label: 'RGB' } },
        params: {},
      },
      {
        ...
        inputs: {
          r: { type: 'float', label: 'R', connection: { nodeId: 'neg_5', outputKey: 'output' } },
          g: { type: 'float', label: 'G', connection: { nodeId: 'cos_3', outputKey: 'output' } },
          b: { type: 'float', label: 'B', connection: { nodeId: 'zero_6', outputKey: 'value' } },
        },
        outputs: { rgb: { type: 'vec3', label: 'RGB' } },
        params: {},
      },
      {
        ...
        inputs: {
          r: { type: 'float', label: 'R', connection: { nodeId: 'zero_6', outputKey: 'value' } },
          g: { type: 'float', label: 'G', connection: { nodeId: 'zero_6', outputKey: 'value' } },
          b: { type: 'float', label: 'B', connection: { nodeId: 'one_7', outputKey: 'value' } },
        },
        outputs: { rgb: { type: 'vec3', label: 'RGB' } },
        params: {},
      },
      {
        ...
        inputs: {
          v0: { type: 'vec3', label: 'Vec 0', connection: { nodeId: 'col0_8', outputKey: 'rgb' } },
          v1: { type: 'vec3', label: 'Vec 1', connection: { nodeId: 'col1_9', outputKey: 'rgb' } },
          v2: { type: 'vec3', label: 'Vec 2', connection: { nodeId: 'col2_10', outputKey: 'rgb' } },
        },
      ...
      },
      {
        ...
        inputs: {
          mat: { type: 'mat3', label: 'Mat3', connection: { nodeId: 'mat_11', outputKey: 'mat' } },
          vec: { type: 'vec3', label: 'Vec3', connection: { nodeId: 'pal_13', outputKey: 'color' } },
        },
  ...
  gridBreathing: {
    ...
    nodes: [
      ...
      },
      {
        ...
        outputs: { result: { type: 'float', label: 'Result' } },
        params: {
          inputs: [{ name: 'cid', type: 'vec2', slider: null }],
          outputType: 'float',
          lines: [],
          result: 'mod(cid.x + cid.y, 2.0) * 3.14159',
          expr: 'a',
          label: 'phase',
        },
      },
      ...
      },
      {
        ...
        outputs: { result: { type: 'float', label: 'Result' } },
        params: {
          inputs: [{ name: 't', type: 'float', slider: null }, { name: 'phi', type: 'float', slider: null }],
          outputType: 'float',
          lines: [],
          result: 'sin(t * 2.0 + phi) * 0.5 + 0.5',
          expr: 'a',
          label: 'osc',
        },
      },
      {
        ...
        outputs: { result: { type: 'float', label: 'Result' } },
        params: {
          inputs: [{ name: 'cuv', type: 'vec2', slider: null }, { name: 'osc', type: 'float', slider: null }],
          outputType: 'float',
          lines: [],
          result: '1.0 - smoothstep(osc * 0.38, osc * 0.38 + 0.02, length(cuv))',
          expr: 'a',
          label: 'dot',
        },
      },
    ...
    nodes: [
      ...
      },
      {
        ...
        params: {
          ...
          outputType: 'vec2',
          lines: [],
          result: 'vec2(sin(t * 0.73) * 0.55, cos(t * 0.41) * 0.38)',
          expr: 'a',
          label: 'pos0',
        },
      },
      {
        ...
        params: {
          ...
          outputType: 'vec2',
          lines: [],
          result: 'vec2(cos(t * 0.47) * 0.48, sin(t * 0.89 + 1.0) * 0.42)',
          expr: 'a',
          label: 'pos1',
        },
      },
      {
        ...
        params: {
          ...
          outputType: 'vec2',
          lines: [],
          result: 'vec2(sin(t * 0.31 + 2.1) * 0.62, cos(t * 0.53 + 0.7) * 0.35)',
          expr: 'a',
          label: 'pos2',
        },
      },
      {
        ...
        outputs: { result: { type: 'float', label: 'Result' } },
        params: {
          inputs: [{ name: 'uv', type: 'vec2', slider: null }, { name: 'p', type: 'vec2', slider: null }],
          outputType: 'float',
          lines: [],
          result: 'length(uv - p) - 0.28',
          expr: 'a',
          label: 'sdf0',
        },
      },
      ...
      },
      {
        ...
        outputs: { result: { type: 'vec3', label: 'Result' } },
        params: {
          inputs: [{ name: 'sdf', type: 'float', slider: null }, { name: 'blend', type: 'float', slider: null }],
          outputType: 'vec3',
          lines: [],
          result: 'smoothstep(0.015, -0.015, sdf) * mix(vec3(1.0,0.35,0.05), vec3(0.05,0.55,1.0), blend)',
          expr: 'a',
          label: 'fill',
        },
      },
    ...
    nodes: [
      ...
      },
      {
        ...
        params: {
          ...
          outputType: 'float',
          lines: [],
          result: '1.0 - smoothstep(0.28, 0.36, d)',
          expr: 'a',
          label: 'soft circle',
        },
      },
      {
        ...
        inputs: {
          t: { type: 'float', label: 'T', connection: { nodeId: 'nd2_grid1', outputKey: 'dist_to_center' } },
        },
        outputs: { color: { type: 'vec3', label: 'Color' } },
        params: {},
      },
      {
        ...
        outputs: { result: { type: 'vec3', label: 'Result' } },
        params: {
          inputs: [{ name: 'mask', type: 'float', slider: null }, { name: 'col', type: 'vec3', slider: null }],
          outputType: 'vec3',
          lines: [],
          result: 'mask * col',
          expr: 'a',
