...
export const EXAMPLE_GRAPHS: Record<string, { label: string; nodes: GraphNode[]; counter: number }> = {
  ...
  gridBasic: {
    ...
    nodes: [
      { id: 'gb_uv0', type: 'uv', position: { x: 60, y: 200 },
        inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'gb_grid1', type: 'gridLayout', position: { x: 300, y: 200 },
        ...
        params: { columns: 10 } },
      { id: 'gb_f2v2', type: 'floatToVec3', position: { x: 560, y: 200 },
        inputs: { input: { type: 'float', label: 'Float', connection: { nodeId: 'gb_grid1', outputKey: 'dist_to_center' } } },
        outputs: { rgb: { type: 'vec3', label: 'Color' } }, params: {} },
      { id: 'gb_out3', type: 'output', position: { x: 780, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'gb_f2v2', outputKey: 'rgb' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid: Circles — Grid node → step circle mask → output ───────────────────
  gridCircles: {
    label: 'Grid: Circles',
    counter: 5,
    nodes: [
      { id: 'gc_uv0', type: 'uv', position: { x: 60, y: 200 },
        inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'gc_grid1', type: 'gridLayout', position: { x: 300, y: 200 },
        ...
        params: { columns: 10 } },
      { id: 'gc_mask2', type: 'exprNode', position: { x: 560, y: 200 },
        inputs: { cellUV: { type: 'vec2', label: 'cellUV', connection: { nodeId: 'gc_grid1', outputKey: 'cellUV' } } },
        outputs: { result: { type: 'float', label: 'Result' } },
  ...
  gridWave: {
    ...
    nodes: [
      { id: 'gw_uv0', type: 'uv', position: { x: 60, y: 200 },
        inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'gw_grid1', type: 'gridLayout', position: { x: 300, y: 200 },
      ...
      // ── WaveRadius compound ─────────────────────────────────────────────────
      { id: 'gw_wave2', type: 'group', position: { x: 580, y: 200 },
        inputs: {
          in0: { type: 'float', label: 'distance', connection: { nodeId: 'gw_grid1', outputKey: 'dist_to_center' } },
        },
        outputs: {
        ...
        params: {
          ...
          subgraph: {
            nodes: [
              { id: 'node_17', type: 'time', position: { x: 60, y: 200 },
                inputs: {}, outputs: { time: { type: 'float', label: 'Time' } },
                params: { _groupOriginal: true } },
              { id: 'node_16', type: 'subtract', position: { x: 380, y: 60 },
                inputs: {
                  a: { type: 'float', label: 'A' },
                  b: { type: 'float', label: 'B', connection: { nodeId: 'node_17', outputKey: 'time' } },
                },
                outputs: { result: { type: 'float', label: 'Result' } },
                params: { b: 0, _groupOriginal: true } },
              { id: 'node_18', type: 'multiply', position: { x: 720, y: 60 },
                inputs: {
                  a: { type: 'float', label: 'A', connection: { nodeId: 'node_16', outputKey: 'result' } },
                  b: { type: 'float', label: 'B' },
                },
                outputs: { result: { type: 'float', label: 'Result' } },
                params: { b: 0.52, _groupOriginal: true } },
              { id: 'node_19', type: 'sin', position: { x: 1060, y: 60 },
                inputs: {
                  input: { type: 'float', label: 'Input', connection: { nodeId: 'node_18', outputKey: 'result' } },
                  freq:  { type: 'float', label: 'Freq' },
                  amp:   { type: 'float', label: 'Amp' },
                },
                outputs: { output: { type: 'float', label: 'Output' } },
                params: { freq: 3.24, amp: 0.19, _groupOriginal: true } },
            ],
            inputPorts: [
              { key: 'in0', type: 'float', label: 'distance', toNodeId: 'node_16', toInputKey: 'a' },
            ],
            outputPorts: [
              { key: 'out1', type: 'float', label: 'wave_radius', fromNodeId: 'node_19', fromOutputKey: 'output' },
            ],
          },
        },
      },
      ...
      { id: 'gw_circ3', type: 'circleSDF', position: { x: 1020, y: 200 },
        inputs: {
          position: { type: 'vec2',  label: 'Position', connection: { nodeId: 'gw_grid1', outputKey: 'cellUV' } },
  ...
  // ── Grid: Neighbor Dots — large radius dots rendered correctly across cell edges ─
  gridNeighborDots: {
    label: 'Grid: Neighbor Dots',
    counter: 6,
    nodes: [
      ...
      { id: 'nd1_grid1', type: 'gridLayout', position: { x: 280, y: 200 },
        ...
        params: { columns: 6 } },
      { id: 'nd1_nd2', type: 'neighborDist', position: { x: 520, y: 200 },
      ...
      { id: 'nd1_step3', type: 'exprNode', position: { x: 740, y: 200 },
        inputs: { d: { type: 'float', label: 'd', connection: { nodeId: 'nd1_nd2', outputKey: 'minDist' } } },
        outputs: { result: { type: 'float', label: 'Result' } },
        params: { inputs: [{ name: 'd', type: 'float', slider: null }],
          outputType: 'float', lines: [], result: '1.0 - step(0.45, d)',
          expr: 'a', label: 'circle' } },
      { id: 'nd1_f2v4', type: 'floatToVec3', position: { x: 960, y: 200 },
        inputs: { input: { type: 'float', label: 'Float', connection: { nodeId: 'nd1_step3', outputKey: 'result' } } },
        outputs: { rgb: { type: 'vec3', label: 'Color' } }, params: {} },
      { id: 'nd1_out5', type: 'output', position: { x: 1180, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'nd1_f2v4', outputKey: 'rgb' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid: Neighbor Displaced — randomly offset dot per cell, no boundary clipping ─
  gridNeighborDisplaced: {
    label: 'Grid: Neighbor Displaced',
    counter: 7,
    nodes: [
      ...
      { id: 'nd2_grid1', type: 'gridLayout', position: { x: 280, y: 200 },
        ...
        params: { columns: 8 } },
      { id: 'nd2_hash2', type: 'exprNode', position: { x: 520, y: 300 },
        inputs: { cellID: { type: 'vec2', label: 'cellID', connection: { nodeId: 'nd2_grid1', outputKey: 'cellID' } } },
        outputs: { result: { type: 'vec2', label: 'Result' } },
        params: { inputs: [{ name: 'cellID', type: 'vec2', slider: null }],
          outputType: 'vec2', lines: [],
          result: '(fract(sin(vec2(dot(cellID, vec2(127.1, 311.7)), dot(cellID, vec2(269.5, 183.3)))) * 43758.5453) - 0.5) * 0.5',
          expr: 'a', label: 'cell hash' } },
      { id: 'nd2_nd3', type: 'neighborDist', position: { x: 760, y: 200 },
        inputs: {
        ...
        outputs: { minDist: { type: 'float', label: 'Min Dist' } },
        params: { neighborhood_size: 1, initial_dist: 999.0 } },
      { id: 'nd2_step4', type: 'exprNode', position: { x: 1000, y: 200 },
        inputs: { d: { type: 'float', label: 'd', connection: { nodeId: 'nd2_nd3', outputKey: 'minDist' } } },
        outputs: { result: { type: 'float', label: 'Result' } },
        params: { inputs: [{ name: 'd', type: 'float', slider: null }],
          outputType: 'float', lines: [], result: '1.0 - step(0.35, d)',
          expr: 'a', label: 'circle' } },
      { id: 'nd2_f2v5', type: 'floatToVec3', position: { x: 1220, y: 200 },
        inputs: { input: { type: 'float', label: 'Float', connection: { nodeId: 'nd2_step4', outputKey: 'result' } } },
        outputs: { rgb: { type: 'vec3', label: 'Color' } }, params: {} },
      { id: 'nd2_out6', type: 'output', position: { x: 1440, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'nd2_f2v5', outputKey: 'rgb' } } },
        outputs: {}, params: {} },
    ],
  },
