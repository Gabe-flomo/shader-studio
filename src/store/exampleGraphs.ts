...
export const EXAMPLE_GRAPHS: Record<string, { label: string; nodes: GraphNode[]; counter: number }> = {
  ...
  // Two mat2 rotation matrices at different speeds chained in series.
  // Directly inspired by the p.xz *= mx; p.yz *= my pattern in ray marchers.
  matrixDoubleRotation: {
    label: 'Matrix: Double Rotation',
    counter: 22,
    nodes: [
      { id: 'uv_1',   type: 'uv',   position: { x: 60,   y: 240 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'time_2', type: 'time', position: { x: 60,   y: 440 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      // angle 1: time * 0.4
      { id: 'mul1_3', type: 'multiply', position: { x: 260, y: 400 },
        inputs: { a: { type: 'float', label: 'A', connection: { nodeId: 'time_2', outputKey: 'time' } }, b: { type: 'float', label: 'B' } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: { b: 0.4 } },
      { id: 'cos1_4', type: 'cos', position: { x: 460, y: 320 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'mul1_3', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'sin1_5', type: 'sin', position: { x: 460, y: 440 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'mul1_3', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'neg1_6', type: 'negate', position: { x: 660, y: 440 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'sin1_5', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'c0a_7', type: 'makeVec2', position: { x: 860, y: 300 },
        inputs: { x: { type: 'float', label: 'X', connection: { nodeId: 'cos1_4', outputKey: 'output' } }, y: { type: 'float', label: 'Y', connection: { nodeId: 'sin1_5', outputKey: 'output' } } },
        outputs: { xy: { type: 'vec2', label: 'XY' } }, params: {} },
      { id: 'c1a_8', type: 'makeVec2', position: { x: 860, y: 440 },
        inputs: { x: { type: 'float', label: 'X', connection: { nodeId: 'neg1_6', outputKey: 'output' } }, y: { type: 'float', label: 'Y', connection: { nodeId: 'cos1_4', outputKey: 'output' } } },
        outputs: { xy: { type: 'vec2', label: 'XY' } }, params: {} },
      { id: 'mat1_9', type: 'mat2Construct', position: { x: 1060, y: 360 },
        inputs: { v0: { type: 'vec2', label: 'Vec 0', connection: { nodeId: 'c0a_7', outputKey: 'xy' } }, v1: { type: 'vec2', label: 'Vec 1', connection: { nodeId: 'c1a_8', outputKey: 'xy' } } },
        outputs: { mat: { type: 'mat2', label: 'Mat2' } }, params: { mode: 'cols' } },
      // angle 2: time * 1.1
      { id: 'mul2_10', type: 'multiply', position: { x: 260, y: 600 },
        inputs: { a: { type: 'float', label: 'A', connection: { nodeId: 'time_2', outputKey: 'time' } }, b: { type: 'float', label: 'B' } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: { b: 1.1 } },
      { id: 'cos2_11', type: 'cos', position: { x: 460, y: 560 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'mul2_10', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'sin2_12', type: 'sin', position: { x: 460, y: 680 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'mul2_10', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'neg2_13', type: 'negate', position: { x: 660, y: 680 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'sin2_12', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'c0b_14', type: 'makeVec2', position: { x: 860, y: 580 },
        inputs: { x: { type: 'float', label: 'X', connection: { nodeId: 'cos2_11', outputKey: 'output' } }, y: { type: 'float', label: 'Y', connection: { nodeId: 'sin2_12', outputKey: 'output' } } },
        outputs: { xy: { type: 'vec2', label: 'XY' } }, params: {} },
      { id: 'c1b_15', type: 'makeVec2', position: { x: 860, y: 720 },
        inputs: { x: { type: 'float', label: 'X', connection: { nodeId: 'neg2_13', outputKey: 'output' } }, y: { type: 'float', label: 'Y', connection: { nodeId: 'cos2_11', outputKey: 'output' } } },
        outputs: { xy: { type: 'vec2', label: 'XY' } }, params: {} },
      { id: 'mat2_16', type: 'mat2Construct', position: { x: 1060, y: 640 },
        inputs: { v0: { type: 'vec2', label: 'Vec 0', connection: { nodeId: 'c0b_14', outputKey: 'xy' } }, v1: { type: 'vec2', label: 'Vec 1', connection: { nodeId: 'c1b_15', outputKey: 'xy' } } },
        outputs: { mat: { type: 'mat2', label: 'Mat2' } }, params: { mode: 'cols' } },
      // apply R1 then R2
      { id: 'rot1_17', type: 'mat2MulVec', position: { x: 1280, y: 280 },
        inputs: { mat: { type: 'mat2', label: 'Mat2', connection: { nodeId: 'mat1_9',  outputKey: 'mat' } }, vec: { type: 'vec2', label: 'Vec2', connection: { nodeId: 'uv_1',    outputKey: 'uv'  } } },
        outputs: { output: { type: 'vec2', label: 'Vec2 out' } }, params: {} },
      { id: 'rot2_18', type: 'mat2MulVec', position: { x: 1480, y: 280 },
        inputs: { mat: { type: 'mat2', label: 'Mat2', connection: { nodeId: 'mat2_16', outputKey: 'mat' } }, vec: { type: 'vec2', label: 'Vec2', connection: { nodeId: 'rot1_17', outputKey: 'output' } } },
        outputs: { output: { type: 'vec2', label: 'Vec2 out' } }, params: {} },
      { id: 'fract_19', type: 'fract', position: { x: 1680, y: 240 },
        inputs: { input: { type: 'vec2', label: 'Input', connection: { nodeId: 'rot2_18', outputKey: 'output' } }, scale: { type: 'float', label: 'Scale' } },
        outputs: { output: { type: 'vec2', label: 'Output' } }, params: { scale: 4.0 } },
      { id: 'circle_20', type: 'circleSDF', position: { x: 1880, y: 200 },
        inputs: { position: { type: 'vec2', label: 'Position', connection: { nodeId: 'fract_19', outputKey: 'output' } }, radius: { type: 'float', label: 'Radius' }, offset: { type: 'vec2', label: 'Offset' } },
        outputs: { distance: { type: 'float', label: 'Distance' } }, params: { radius: 0.28 } },
      { id: 'colorize_21', type: 'sdfColorize', position: { x: 2100, y: 200 },
        inputs: { d: { type: 'float', label: 'SDF', connection: { nodeId: 'circle_20', outputKey: 'distance' } }, inside: { type: 'vec3', label: 'Inside Color' }, outside: { type: 'vec3', label: 'Outside Color' }, edge: { type: 'float', label: 'Edge Softness' } },
        outputs: { result: { type: 'vec3', label: 'Color' } }, params: { edge: 0.015, inside: [0.1, 0.8, 0.9], outside: [0.05, 0.02, 0.08] } },
      { id: 'output_22', type: 'output', position: { x: 2320, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'colorize_21', outputKey: 'result' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Matrix: RGB Color Rotation ─────────────────────────────────────────────
  // A mat3 built from cos/sin of time acts as a rotation in RGB color space.
  // Inspired by the ACES mat3 tonemap pattern — two matrix multiplications on a color vec3.
  matrixColorRotation: {
    label: 'Matrix: RGB Color Rotation',
    counter: 15,
    nodes: [
      ...
      // cos/sin of time for animated rotation matrix
      ...
      { id: 'neg_5', type: 'negate', position: { x: 460, y: 480 },
        ...
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      // Constant 0 and 1 for matrix entries
      ...
      // Three column vectors for the mat3 — rotation in RG plane, B unchanged
      ...
      // Input color: cosine palette driven by radial distance
      ...
      { id: 'mix_14', type: 'mat3MulVec', position: { x: 1100, y: 340 },
      ...
      { id: 'output_15', type: 'output', position: { x: 1320, y: 340 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'mix_14', outputKey: 'output' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Matrix: Inspect & Stretch ──────────────────────────────────────────────
  // Decompose a rotation matrix into columns, scale one column with sin(time),
  // then reassemble — creates a pulsing non-uniform warp.
  matrixStretch: {
    label: 'Matrix: Inspect & Stretch',
    counter: 19,
    nodes: [
      { id: 'uv_1',   type: 'uv',   position: { x: 60,  y: 200 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'time_2', type: 'time', position: { x: 60,  y: 440 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      // Base rotation matrix
      { id: 'cos_3', type: 'cos', position: { x: 260, y: 360 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'time_2', outputKey: 'time' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'sin_4', type: 'sin', position: { x: 260, y: 480 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'time_2', outputKey: 'time' } } },
      ...
      { id: 'neg_5', type: 'negate', position: { x: 460, y: 480 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'sin_4', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'col0_6', type: 'makeVec2', position: { x: 660, y: 360 },
        inputs: { x: { type: 'float', label: 'X', connection: { nodeId: 'cos_3', outputKey: 'output' } }, y: { type: 'float', label: 'Y', connection: { nodeId: 'sin_4', outputKey: 'output' } } },
        outputs: { xy: { type: 'vec2', label: 'XY' } }, params: {} },
      { id: 'col1_7', type: 'makeVec2', position: { x: 660, y: 500 },
        inputs: { x: { type: 'float', label: 'X', connection: { nodeId: 'neg_5', outputKey: 'output' } }, y: { type: 'float', label: 'Y', connection: { nodeId: 'cos_3', outputKey: 'output' } } },
        outputs: { xy: { type: 'vec2', label: 'XY' } }, params: {} },
      { id: 'mat_8', type: 'mat2Construct', position: { x: 880, y: 420 },
        inputs: { v0: { type: 'vec2', label: 'Vec 0', connection: { nodeId: 'col0_6', outputKey: 'xy' } }, v1: { type: 'vec2', label: 'Vec 1', connection: { nodeId: 'col1_7', outputKey: 'xy' } } },
        outputs: { mat: { type: 'mat2', label: 'Mat2' } }, params: { mode: 'cols' } },
      // Inspect to extract columns
      { id: 'inspect_9', type: 'mat2Inspect', position: { x: 1080, y: 420 },
        inputs: { mat: { type: 'mat2', label: 'Mat2', connection: { nodeId: 'mat_8', outputKey: 'mat' } } },
        outputs: { mat: { type: 'mat2', label: 'Mat2' }, vec0: { type: 'vec2', label: 'Vec 0' }, vec1: { type: 'vec2', label: 'Vec 1' } },
        params: { mode: 'cols' } },
      // Scale col0 by sin(time*2)+1.5 — pulsing stretch along one axis
      { id: 'mul_t_10', type: 'multiply', position: { x: 260, y: 620 },
        inputs: { a: { type: 'float', label: 'A', connection: { nodeId: 'time_2', outputKey: 'time' } }, b: { type: 'float', label: 'B' } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: { b: 2.0 } },
      { id: 'sin_t_11', type: 'sin', position: { x: 460, y: 620 },
        inputs: { input: { type: 'float', label: 'Input', connection: { nodeId: 'mul_t_10', outputKey: 'output' } } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: {} },
      { id: 'add_12', type: 'add', position: { x: 660, y: 620 },
        inputs: { a: { type: 'float', label: 'A', connection: { nodeId: 'sin_t_11', outputKey: 'output' } }, b: { type: 'float', label: 'B' } },
        outputs: { output: { type: 'float', label: 'Output' } }, params: { b: 1.5 } },
      { id: 'scale_13', type: 'multiplyVec2', position: { x: 1280, y: 380 },
        inputs: { v: { type: 'vec2', label: 'Vec2', connection: { nodeId: 'inspect_9', outputKey: 'vec0' } }, scale: { type: 'float', label: 'Scale', connection: { nodeId: 'add_12', outputKey: 'output' } } },
        outputs: { result: { type: 'vec2', label: 'Result' } }, params: {} },
      // Reassemble with scaled col0, original col1
      { id: 'remat_14', type: 'mat2Construct', position: { x: 1480, y: 440 },
        inputs: { v0: { type: 'vec2', label: 'Vec 0', connection: { nodeId: 'scale_13',  outputKey: 'result' } }, v1: { type: 'vec2', label: 'Vec 1', connection: { nodeId: 'inspect_9', outputKey: 'vec1'  } } },
        outputs: { mat: { type: 'mat2', label: 'Mat2' } }, params: { mode: 'cols' } },
      // Apply and render
      { id: 'mul_15', type: 'mat2MulVec', position: { x: 1700, y: 300 },
        inputs: { mat: { type: 'mat2', label: 'Mat2', connection: { nodeId: 'remat_14', outputKey: 'mat' } }, vec: { type: 'vec2', label: 'Vec2', connection: { nodeId: 'uv_1', outputKey: 'uv' } } },
        outputs: { output: { type: 'vec2', label: 'Vec2 out' } }, params: {} },
      { id: 'fract_16', type: 'fract', position: { x: 1900, y: 260 },
        inputs: { input: { type: 'vec2', label: 'Input', connection: { nodeId: 'mul_15', outputKey: 'output' } }, scale: { type: 'float', label: 'Scale' } },
        outputs: { output: { type: 'vec2', label: 'Output' } }, params: { scale: 5.0 } },
      { id: 'circle_17', type: 'circleSDF', position: { x: 2100, y: 220 },
        inputs: { position: { type: 'vec2', label: 'Position', connection: { nodeId: 'fract_16', outputKey: 'output' } }, radius: { type: 'float', label: 'Radius' }, offset: { type: 'vec2', label: 'Offset' } },
        outputs: { distance: { type: 'float', label: 'Distance' } }, params: { radius: 0.25 } },
      { id: 'colorize_18', type: 'sdfColorize', position: { x: 2300, y: 220 },
        inputs: { d: { type: 'float', label: 'SDF', connection: { nodeId: 'circle_17', outputKey: 'distance' } }, inside: { type: 'vec3', label: 'Inside Color' }, outside: { type: 'vec3', label: 'Outside Color' }, edge: { type: 'float', label: 'Edge Softness' } },
        outputs: { result: { type: 'vec3', label: 'Color' } }, params: { edge: 0.015, inside: [0.9, 0.4, 0.1], outside: [0.05, 0.02, 0.05] } },
      { id: 'output_19', type: 'output', position: { x: 2520, y: 220 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'colorize_18', outputKey: 'result' } } },
        outputs: {}, params: {} },
    ],
  },
