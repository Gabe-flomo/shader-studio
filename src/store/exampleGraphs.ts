...
export const EXAMPLE_GRAPHS: Record<string, { label: string; nodes: GraphNode[]; counter: number }> = {
  ...
  // ── Bloom — glowing fractal rings ────────────────────────────────────────
  bloomGlowRings: {
    label: 'Bloom',
    counter: 7,
    nodes: [
      { id: 'bl_uv',   type: 'uv',   position: { x: 40,  y: 200 }, inputs: {}, outputs: { uv:   { type: 'vec2',  label: 'UV'   } }, params: {} },
      { id: 'bl_time', type: 'time', position: { x: 40,  y: 380 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      {
        id: 'bl_frac', type: 'fractalLoop', position: { x: 280, y: 120 },
        inputs: {
          uv:   { type: 'vec2',  label: 'UV',   connection: { nodeId: 'bl_uv',   outputKey: 'uv'   } },
          time: { type: 'float', label: 'Time', connection: { nodeId: 'bl_time', outputKey: 'time' } },
        },
        outputs: { color: { type: 'vec3', label: 'Color' }, uv_final: { type: 'vec2', label: 'UV Final' }, uv0: { type: 'vec2', label: 'UV0' } },
      ...
      },
      {
        ...
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'bl_bloom', outputKey: 'result' } } },
        outputs: {}, params: {},
      },
    ],
  },

  // ── Stochastic Bloom — sparse neon rings ─────────────────────────────────
  stochasticBloomNeon: {
    label: 'Stochastic Bloom',
    counter: 8,
    nodes: [
      { id: 'sb_uv',   type: 'uv',   position: { x: 40,  y: 200 }, inputs: {}, outputs: { uv:   { type: 'vec2',  label: 'UV'   } }, params: {} },
      { id: 'sb_time', type: 'time', position: { x: 40,  y: 380 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      {
        id: 'sb_frac', type: 'fractalLoop', position: { x: 280, y: 120 },
        inputs: {
      ...
      },
      {
        ...
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'sb_bloom', outputKey: 'result' } } },
        outputs: {}, params: {},
      },
    ],
  },
