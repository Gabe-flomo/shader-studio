...
export const EXAMPLE_GRAPHS: Record<string, { label: string; nodes: GraphNode[]; counter: number }> = {
  ...
  // ── Grid 3D: Sphere Grid (mirrors 2D gridBasic) ───────────────────────────────
  // scenePos → grid3d → cellUV(world-space) → sphereSDF3D → marchLoopGroup
  grid3dSpheres: {
    label: 'Grid 3D: Sphere Grid',
    counter: 6,
    nodes: [
      { id: 'g3ds_uv0',  type: 'uv',   position: { x: 60,  y: 100 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3ds_t1',   type: 'time', position: { x: 60,  y: 240 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3ds_cam2', type: 'marchCamera', position: { x: 280, y: 160 },
        inputs: {
          uv:   { type: 'vec2',  label: 'UV',   connection: { nodeId: 'g3ds_uv0', outputKey: 'uv'   } },
          time: { type: 'float', label: 'Time', connection: { nodeId: 'g3ds_t1',  outputKey: 'time' } },
        },
        outputs: { ro: { type: 'vec3', label: 'Ray Origin' }, rd: { type: 'vec3', label: 'Ray Dir' } },
        params: { camDist: 5.0, camAngle: 0.6, camElevation: 0.4, rotSpeed: 0.18, fov: 1.5 } },
      { id: 'g3ds_sc3', type: 'sceneGroup', position: { x: 540, y: 360 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          label: 'Grid 3D Spheres',
          subgraph: {
            nodes: [
              { id: 'sp', type: 'scenePos', position: { x: 60, y: 140 },
                inputs: {}, outputs: { pos: { type: 'vec3', label: 'Position' } }, params: {} },
              { id: 'g3d', type: 'grid3d', position: { x: 240, y: 140 },
                inputs: { pos: { type: 'vec3', label: 'Pos', connection: { nodeId: 'sp', outputKey: 'pos' } } },
                outputs: { cellUV: { type: 'vec3', label: 'Cell UV' }, cellID: { type: 'vec3', label: 'Cell ID' }, cellCenter: { type: 'vec3', label: 'Cell Center' }, cellSize: { type: 'float', label: 'Cell Size' }, gridPos: { type: 'vec3', label: 'Grid Pos' }, distToOrigin: { type: 'float', label: 'Dist to Origin' } },
                params: { columns: 4, uniform_scale: 2.0 } },
              { id: 'sph', type: 'sphereSDF3D', position: { x: 480, y: 140 },
                inputs: { pos: { type: 'vec3', label: 'Position', connection: { nodeId: 'g3d', outputKey: 'cellUV' } } },
                outputs: { dist: { type: 'float', label: 'Distance' } },
                params: { radius: 0.22 } },
            ],
            inputPorts: [], outputPorts: [],
            outputNodeId: 'sph', outputKey: 'dist',
          },
        } },
      { id: 'g3ds_mlg4', type: 'marchLoopGroup', position: { x: 820, y: 200 },
        inputs: {
          ro:    { type: 'vec3',    label: 'Ray Origin', connection: { nodeId: 'g3ds_cam2', outputKey: 'ro'    } },
          rd:    { type: 'vec3',    label: 'Ray Dir',    connection: { nodeId: 'g3ds_cam2', outputKey: 'rd'    } },
          scene: { type: 'scene3d', label: 'Scene',      connection: { nodeId: 'g3ds_sc3',  outputKey: 'scene' } },
        },
        outputs: { color: { type: 'vec3', label: 'Color' }, normal: { type: 'vec3', label: 'Normal' }, dist: { type: 'float', label: 'Dist' }, hit: { type: 'float', label: 'Hit' } },
        params: {
          maxSteps: 80, maxDist: 30.0, stepScale: 1.0,
          bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.55, albedoG: 0.8, albedoB: 0.9,
          subgraph: {
            nodes: [
              { id: 'mp', type: 'marchPos',    position: { x: 100, y: 140 }, inputs: {}, outputs: { pos: { type: 'vec3', label: 'March Pos' } }, params: {} },
              { id: 'mo', type: 'marchOutput', position: { x: 340, y: 140 },
                inputs: { pos: { type: 'vec3', label: 'Position', connection: { nodeId: 'mp', outputKey: 'pos' } } },
                outputs: {}, params: {} },
            ],
            inputPorts: [], outputPorts: [],
      ...
      { id: 'g3ds_out5', type: 'output', position: { x: 1100, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3ds_mlg4', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid 3D: Wave Spheres (mirrors 2D gridCircles/gridWave) ──────────────────
  // distToOrigin drives WaveRadius → sphere radii ripple outward from grid origin
  grid3dWave: {
    label: 'Grid 3D: Wave Spheres',
    counter: 6,
    nodes: [
      { id: 'g3dw_uv0',  type: 'uv',   position: { x: 60,  y: 100 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3dw_t1',   type: 'time', position: { x: 60,  y: 240 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3dw_cam2', type: 'marchCamera', position: { x: 280, y: 160 },
        inputs: {
          uv:   { type: 'vec2',  label: 'UV',   connection: { nodeId: 'g3dw_uv0', outputKey: 'uv'   } },
          time: { type: 'float', label: 'Time', connection: { nodeId: 'g3dw_t1',  outputKey: 'time' } },
        },
        outputs: { ro: { type: 'vec3', label: 'Ray Origin' }, rd: { type: 'vec3', label: 'Ray Dir' } },
        params: { camDist: 5.0, camAngle: 0.6, camElevation: 0.4, rotSpeed: 0.18, fov: 1.5 } },
      { id: 'g3dw_sc3', type: 'sceneGroup', position: { x: 540, y: 360 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          label: 'Grid 3D Wave',
          subgraph: {
            nodes: [
              { id: 'sp', type: 'scenePos', position: { x: 60, y: 180 },
                inputs: {}, outputs: { pos: { type: 'vec3', label: 'Position' } }, params: {} },
              { id: 'g3d', type: 'grid3d', position: { x: 240, y: 180 },
                inputs: { pos: { type: 'vec3', label: 'Pos', connection: { nodeId: 'sp', outputKey: 'pos' } } },
                outputs: { cellUV: { type: 'vec3', label: 'Cell UV' }, cellID: { type: 'vec3', label: 'Cell ID' }, cellCenter: { type: 'vec3', label: 'Cell Center' }, cellSize: { type: 'float', label: 'Cell Size' }, gridPos: { type: 'vec3', label: 'Grid Pos' }, distToOrigin: { type: 'float', label: 'Dist to Origin' } },
                params: { columns: 4, uniform_scale: 2.0 } },
              { id: 'wr', type: 'waveRadius', position: { x: 480, y: 320 },
                inputs: { distance: { type: 'float', label: 'Distance', connection: { nodeId: 'g3d', outputKey: 'distToOrigin' } } },
                outputs: { wave_radius: { type: 'float', label: 'Wave Radius' } },
                params: { speed: 1.2, freq: 2.5, amp: 0.1, base: 0.15 } },
              { id: 'sph', type: 'sphereSDF3D', position: { x: 700, y: 180 },
                inputs: {
                  pos:    { type: 'vec3',  label: 'Position', connection: { nodeId: 'g3d', outputKey: 'cellUV'      } },
                  radius: { type: 'float', label: 'Radius',   connection: { nodeId: 'wr',  outputKey: 'wave_radius' } },
                },
                outputs: { dist: { type: 'float', label: 'Distance' } },
                params: { radius: 0.18 } },
            ],
      ...
      { id: 'g3dw_mlg4', type: 'marchLoopGroup', position: { x: 820, y: 200 },
        inputs: {
          ro:    { type: 'vec3',    label: 'Ray Origin', connection: { nodeId: 'g3dw_cam2', outputKey: 'ro'    } },
          rd:    { type: 'vec3',    label: 'Ray Dir',    connection: { nodeId: 'g3dw_cam2', outputKey: 'rd'    } },
          scene: { type: 'scene3d', label: 'Scene',      connection: { nodeId: 'g3dw_sc3',  outputKey: 'scene' } },
        },
        outputs: { color: { type: 'vec3', label: 'Color' }, normal: { type: 'vec3', label: 'Normal' }, dist: { type: 'float', label: 'Dist' } },
        params: {
          maxSteps: 80, maxDist: 30.0, stepScale: 1.0,
          bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.9, albedoG: 0.6, albedoB: 0.4,
          subgraph: {
            nodes: [
              { id: 'mp', type: 'marchPos',    position: { x: 100, y: 140 }, inputs: {}, outputs: { pos: { type: 'vec3', label: 'March Pos' } }, params: {} },
              { id: 'mo', type: 'marchOutput', position: { x: 340, y: 140 },
      ...
      { id: 'g3dw_out5', type: 'output', position: { x: 1100, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3dw_mlg4', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid 3D: Pulse (mirrors 2D gridNeighborDots / Grid: Pulse) ───────────────
  // NeighborDist3D + WaveRadius: pulsing spheres that don't clip at cell boundaries
  grid3dNeighbor: {
    label: 'Grid 3D: Pulse',
    counter: 6,
    nodes: [
      { id: 'g3dn_uv0',  type: 'uv',   position: { x: 60,  y: 100 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3dn_t1',   type: 'time', position: { x: 60,  y: 240 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3dn_cam2', type: 'marchCamera', position: { x: 280, y: 160 },
        inputs: {
          uv:   { type: 'vec2',  label: 'UV',   connection: { nodeId: 'g3dn_uv0', outputKey: 'uv'   } },
          time: { type: 'float', label: 'Time', connection: { nodeId: 'g3dn_t1',  outputKey: 'time' } },
        },
        outputs: { ro: { type: 'vec3', label: 'Ray Origin' }, rd: { type: 'vec3', label: 'Ray Dir' } },
        params: { camDist: 5.0, camAngle: 0.6, camElevation: 0.4, rotSpeed: 0.18, fov: 1.5 } },
      { id: 'g3dn_sc3', type: 'sceneGroup', position: { x: 540, y: 360 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          label: 'Grid 3D Pulse',
          subgraph: {
            nodes: [
              { id: 'sp', type: 'scenePos', position: { x: 60, y: 200 },
                inputs: {}, outputs: { pos: { type: 'vec3', label: 'Position' } }, params: {} },
              { id: 'g3d', type: 'grid3d', position: { x: 240, y: 200 },
                inputs: { pos: { type: 'vec3', label: 'Pos', connection: { nodeId: 'sp', outputKey: 'pos' } } },
                outputs: { cellUV: { type: 'vec3', label: 'Cell UV' }, cellID: { type: 'vec3', label: 'Cell ID' }, cellCenter: { type: 'vec3', label: 'Cell Center' }, cellSize: { type: 'float', label: 'Cell Size' }, gridPos: { type: 'vec3', label: 'Grid Pos' }, distToOrigin: { type: 'float', label: 'Dist to Origin' } },
                params: { columns: 4, uniform_scale: 2.0 } },
              { id: 'nd', type: 'neighborDist3d', position: { x: 480, y: 120 },
                inputs: {
                  uv:       { type: 'vec3',  label: 'UV',        connection: { nodeId: 'g3d', outputKey: 'cellUV'   } },
                  cellSize: { type: 'float', label: 'Cell Size', connection: { nodeId: 'g3d', outputKey: 'cellSize' } },
                },
                outputs: { minDist: { type: 'float', label: 'Min Dist' } },
                params: { neighborhood_size: 1, dispScale: 0.35 } },
              { id: 'wr', type: 'waveRadius', position: { x: 480, y: 320 },
                inputs: { distance: { type: 'float', label: 'Distance', connection: { nodeId: 'g3d', outputKey: 'distToOrigin' } } },
                outputs: { wave_radius: { type: 'float', label: 'Wave Radius' } },
                params: { speed: 1.0, freq: 2.2, amp: 0.08, base: 0.14 } },
              { id: 'sdf', type: 'exprNode', position: { x: 700, y: 200 },
                inputs: {
                  d:  { type: 'float', label: 'd',  connection: { nodeId: 'nd', outputKey: 'minDist'     } },
                  wr: { type: 'float', label: 'wr', connection: { nodeId: 'wr', outputKey: 'wave_radius' } },
                },
                outputs: { result: { type: 'float', label: 'Result' } },
                params: {
                  inputs: [{ name: 'd', type: 'float', slider: null }, { name: 'wr', type: 'float', slider: null }],
                  outputType: 'float', lines: [], result: 'd - wr', expr: 'd - wr', label: 'sphere SDF',
                } },
            ],
            inputPorts: [], outputPorts: [],
            outputNodeId: 'sdf', outputKey: 'result',
          },
        } },
      { id: 'g3dn_mlg4', type: 'marchLoopGroup', position: { x: 820, y: 200 },
        inputs: {
          ro:    { type: 'vec3',    label: 'Ray Origin', connection: { nodeId: 'g3dn_cam2', outputKey: 'ro'    } },
          rd:    { type: 'vec3',    label: 'Ray Dir',    connection: { nodeId: 'g3dn_cam2', outputKey: 'rd'    } },
          scene: { type: 'scene3d', label: 'Scene',      connection: { nodeId: 'g3dn_sc3',  outputKey: 'scene' } },
        },
        outputs: { color: { type: 'vec3', label: 'Color' }, normal: { type: 'vec3', label: 'Normal' }, dist: { type: 'float', label: 'Dist' } },
        params: {
          maxSteps: 80, maxDist: 30.0, stepScale: 1.0,
          bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.4, albedoG: 0.75, albedoB: 0.5,
          subgraph: {
            nodes: [
              { id: 'mp', type: 'marchPos',    position: { x: 100, y: 140 }, inputs: {}, outputs: { pos: { type: 'vec3', label: 'March Pos' } }, params: {} },
              { id: 'mo', type: 'marchOutput', position: { x: 340, y: 140 },
      ...
      { id: 'g3dn_out5', type: 'output', position: { x: 1100, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3dn_mlg4', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid 3D: Scatter (mirrors 2D gridNeighborDisplaced / Grid: Scatter) ──────
  // cellID → neighborDist3d hash mode: each sphere randomly displaced from cell center
  grid3dScatter: {
    label: 'Grid 3D: Scatter',
    counter: 6,
    nodes: [
      { id: 'g3dx_uv0',  type: 'uv',   position: { x: 60,  y: 100 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3dx_t1',   type: 'time', position: { x: 60,  y: 240 }, inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3dx_cam2', type: 'marchCamera', position: { x: 280, y: 160 },
        inputs: {
          uv:   { type: 'vec2',  label: 'UV',   connection: { nodeId: 'g3dx_uv0', outputKey: 'uv'   } },
          time: { type: 'float', label: 'Time', connection: { nodeId: 'g3dx_t1',  outputKey: 'time' } },
        },
        outputs: { ro: { type: 'vec3', label: 'Ray Origin' }, rd: { type: 'vec3', label: 'Ray Dir' } },
        params: { camDist: 5.0, camAngle: 0.6, camElevation: 0.4, rotSpeed: 0.18, fov: 1.5 } },
      { id: 'g3dx_sc3', type: 'sceneGroup', position: { x: 540, y: 360 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          label: 'Grid 3D Scatter',
          subgraph: {
            nodes: [
              ...
              { id: 'g3d', type: 'grid3d', position: { x: 240, y: 200 },
                ...
                outputs: { cellUV: { type: 'vec3', label: 'Cell UV' }, cellID: { type: 'vec3', label: 'Cell ID' }, cellCenter: { type: 'vec3', label: 'Cell Center' }, cellSize: { type: 'float', label: 'Cell Size' }, gridPos: { type: 'vec3', label: 'Grid Pos' }, distToOrigin: { type: 'float', label: 'Dist to Origin' } },
                params: { columns: 4, uniform_scale: 2.0 } },
              { id: 'nd', type: 'neighborDist3d', position: { x: 480, y: 200 },
                inputs: {
                  uv:       { type: 'vec3',  label: 'UV',        connection: { nodeId: 'g3d', outputKey: 'cellUV'   } },
                  cellID:   { type: 'vec3',  label: 'Cell ID',   connection: { nodeId: 'g3d', outputKey: 'cellID'   } },
                  cellSize: { type: 'float', label: 'Cell Size', connection: { nodeId: 'g3d', outputKey: 'cellSize' } },
                },
                outputs: { minDist: { type: 'float', label: 'Min Dist' } },
                params: { neighborhood_size: 1, dispScale: 0.35 } },
              { id: 'sdf', type: 'exprNode', position: { x: 700, y: 200 },
                inputs: { d: { type: 'float', label: 'd', connection: { nodeId: 'nd', outputKey: 'minDist' } } },
                outputs: { result: { type: 'float', label: 'Result' } },
                params: {
                  inputs: [{ name: 'd', type: 'float', slider: null }],
                  outputType: 'float', lines: [], result: 'd - 0.18', expr: 'd - 0.18', label: 'sphere SDF',
                } },
            ],
            inputPorts: [], outputPorts: [],
            outputNodeId: 'sdf', outputKey: 'result',
      ...
      { id: 'g3dx_mlg4', type: 'marchLoopGroup', position: { x: 820, y: 200 },
        inputs: {
          ro:    { type: 'vec3',    label: 'Ray Origin', connection: { nodeId: 'g3dx_cam2', outputKey: 'ro'    } },
          rd:    { type: 'vec3',    label: 'Ray Dir',    connection: { nodeId: 'g3dx_cam2', outputKey: 'rd'    } },
          scene: { type: 'scene3d', label: 'Scene',      connection: { nodeId: 'g3dx_sc3',  outputKey: 'scene' } },
        },
        outputs: { color: { type: 'vec3', label: 'Color' }, normal: { type: 'vec3', label: 'Normal' }, dist: { type: 'float', label: 'Dist' } },
        params: {
          maxSteps: 80, maxDist: 30.0, stepScale: 1.0,
          bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.8, albedoG: 0.5, albedoB: 0.9,
          subgraph: {
            nodes: [
              { id: 'mp', type: 'marchPos',    position: { x: 100, y: 140 }, inputs: {}, outputs: { pos: { type: 'vec3', label: 'March Pos' } }, params: {} },
              { id: 'mo', type: 'marchOutput', position: { x: 340, y: 140 },
      ...
      { id: 'g3dx_out5', type: 'output', position: { x: 1100, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3dx_mlg4', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },
