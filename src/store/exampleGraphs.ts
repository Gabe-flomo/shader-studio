  ...
  mandelbrotSet: {
    ...
    nodes: [
      { id: 'uv_0',   type: 'uv',   position: { x: 40, y: 240 }, inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      {
        ...
        params: { mode: 'mandelbrot', precision: 'standard', power: 2, max_iter: 150, bailout: 256, zoom: 1.0, zoom_exp: 0.0, center_x: -0.5, center_y: 0.0, cx: -0.7269, cy: 0.1889, orbit_trap: 'none', trap_x: 0.0, trap_y: 0.0, trap_r: 0.5, palette_preset: '1', color_scale: 0.15, color_offset: 0.0 },
      },
      {
  ...
  juliaExplorer: {
    ...
    nodes: [
        ...
        params: { expr: 'vec2(cos(t * 0.3) * 0.7, sin(t * 0.4) * 0.4)', outputType: 'vec2', in0Name: 't', in1Name: 'in1', in2Name: 'in2', in3Name: 'in3' } },
      {
        ...
        params: { mode: 'julia', precision: 'standard', power: 2, max_iter: 150, bailout: 256, zoom: 1.5, zoom_exp: 0.0, center_x: 0.0, center_y: 0.0, cx: -0.7269, cy: 0.1889, orbit_trap: 'cross', trap_x: 0.0, trap_y: 0.0, trap_r: 0.5, palette_preset: '7', color_scale: 0.15, color_offset: 0.0 },
      },
      {
  ...
  gravitationalLens: {
    ...
    nodes: [
      ...
      },
      {
        ...
        params: { mode: 'mandelbrot', precision: 'standard', power: 2, max_iter: 150, bailout: 256, zoom: 1.0, zoom_exp: 0, center_x: -0.5, center_y: 0, orbit_trap: 'none', trap_x: 0, trap_y: 0, trap_r: 0.5, palette_preset: '1', color_scale: 0.3, color_offset: 0 },
      },
      {
