    ...
    nodes: [
      ...
      },
      {
        ...
        params: {
          ...
          samples: 8.0, shininess: 80.0, diffuseness: 0.45, saturation: 1.8,
          lightX: 0.8, lightY: 1.2, lightZ: 0.5,
          tintR: 0.75, tintG: 0.95, tintB: 1.0,
        },
      },
  ...
  glassMetaballs: {
    ...
    nodes: [
      ...
      },
      {
        ...
        outputs: { color: { type: 'vec3', label: 'Glass Color' } },
        params: { ior: 1.45, fresnelPow: 3.0, dispersion: 0.09, samples: 8.0, shininess: 60.0, diffuseness: 0.35, saturation: 2.2, lightX: 0.8, lightY: 1.5, lightZ: 0.4, tintR: 0.85, tintG: 0.98, tintB: 1.0 },
      },
      { id: 'tone_6', type: 'toneMap', position: { x: 1340, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'glass_5', outputKey: 'color' } } },
        outputs: { color: { type: 'vec3', label: 'Color' } }, params: { mode: 'aces' } },
  ...
  glassRoundBox: {
    ...
    nodes: [
      ...
      },
      {
        ...
        outputs: { color: { type: 'vec3', label: 'Glass Color' } },
        params: { ior: 1.6, fresnelPow: 4.0, dispersion: 0.05, samples: 6.0, shininess: 120.0, diffuseness: 0.5, saturation: 1.6, lightX: 1.0, lightY: 1.8, lightZ: 0.6, tintR: 1.0, tintG: 0.98, tintB: 0.85 },
      },
      { id: 'tone_6', type: 'toneMap', position: { x: 1340, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'glass_5', outputKey: 'color' } } },
        outputs: { color: { type: 'vec3', label: 'Color' } }, params: { mode: 'aces' } },
  ...
  glassLavaBlob: {
    ...
    nodes: [
      ...
      },
      {
        ...
        outputs: { color: { type: 'vec3', label: 'Glass Color' } },
        params: { ior: 1.4, fresnelPow: 2.5, dispersion: 0.1, samples: 10.0, shininess: 40.0, diffuseness: 0.3, saturation: 2.6, lightX: 0.6, lightY: 1.8, lightZ: 0.5, tintR: 0.9, tintG: 1.0, tintB: 0.95 },
      },
      { id: 'tone_6', type: 'toneMap', position: { x: 1340, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'glass_5', outputKey: 'color' } } },
        outputs: { color: { type: 'vec3', label: 'Color' } }, params: { mode: 'aces' } },
