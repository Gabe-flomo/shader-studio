...
export const EXAMPLE_GRAPHS: Record<string, { label: string; nodes: GraphNode[]; counter: number }> = {
  ...
  // ── Grid 3D: Sphere Grid ──────────────────────────────────────────────────────
  // Minimal example: scenePos → Grid 3D → cellUV → Sphere SDF → rayMarch
  grid3dSpheres: {
    label: 'Grid 3D: Sphere Grid',
    counter: 5,
    nodes: [
      { id: 'g3ds_uv0', type: 'uv', position: { x: 60, y: 200 },
        inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3ds_t1', type: 'time', position: { x: 60, y: 360 },
        inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3ds_sc2', type: 'sceneGroup', position: { x: 280, y: 220 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          ...
          subgraph: {
            nodes: [
              { id: 'sp_sg', type: 'scenePos', position: { x: 60, y: 180 },
                inputs: {}, outputs: { pos: { type: 'vec3', label: 'Position' } }, params: {} },
              { id: 'g3d_sg', type: 'grid3d', position: { x: 240, y: 180 },
                inputs: { pos: { type: 'vec3', label: 'Pos', connection: { nodeId: 'sp_sg', outputKey: 'pos' } } },
                outputs: {
                ...
                params: { columns: 4, uniform_scale: 1.0 } },
              { id: 'sph_sg', type: 'sphereSDF3D', position: { x: 480, y: 180 },
                inputs: { pos: { type: 'vec3', label: 'Position', connection: { nodeId: 'g3d_sg', outputKey: 'cellUV' } } },
                outputs: { dist: { type: 'float', label: 'Distance' } },
                params: { radius: 0.4 } },
            ],
            outputNodeId: 'sph_sg',
      ...
      { id: 'g3ds_ray3', type: 'rayMarch', position: { x: 540, y: 180 },
        inputs: {
          scene: { type: 'scene3d', label: 'Scene', connection: { nodeId: 'g3ds_sc2', outputKey: 'scene' } },
        ...
        outputs: { color: { type: 'vec3', label: 'Color' }, depth: { type: 'float', label: 'Depth' }, normal: { type: 'vec3', label: 'Normal' } },
        params: { camDist: 4.0, fov: 1.2, maxSteps: 80, maxDist: 20.0, lightX: 2.0, lightY: 4.0, lightZ: 3.0, bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.55, albedoG: 0.8, albedoB: 0.9 } },
      { id: 'g3ds_out4', type: 'output', position: { x: 820, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3ds_ray3', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid 3D: Wave Spheres ─────────────────────────────────────────────────────
  // distToOrigin drives WaveRadius → animated sphere radii ripple outward from center
  grid3dWave: {
    label: 'Grid 3D: Wave Spheres',
    counter: 5,
    nodes: [
      { id: 'g3dw_uv0', type: 'uv', position: { x: 60, y: 200 },
        inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3dw_t1', type: 'time', position: { x: 60, y: 360 },
        inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3dw_sc2', type: 'sceneGroup', position: { x: 280, y: 220 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          label: 'Grid 3D Wave',
          subgraph: {
            nodes: [
              { id: 'sp_sg', type: 'scenePos', position: { x: 60, y: 200 },
                inputs: {}, outputs: { pos: { type: 'vec3', label: 'Position' } }, params: {} },
              { id: 'g3d_sg', type: 'grid3d', position: { x: 240, y: 200 },
                inputs: { pos: { type: 'vec3', label: 'Pos', connection: { nodeId: 'sp_sg', outputKey: 'pos' } } },
                outputs: {
                  cellUV:       { type: 'vec3',  label: 'Cell UV' },
                  cellID:       { type: 'vec3',  label: 'Cell ID' },
                ...
                params: { columns: 5, uniform_scale: 1.2 } },
              { id: 'wr_sg', type: 'waveRadius', position: { x: 480, y: 340 },
                inputs: { distance: { type: 'float', label: 'Distance', connection: { nodeId: 'g3d_sg', outputKey: 'distToOrigin' } } },
                outputs: { wave_radius: { type: 'float', label: 'Wave Radius' } },
                params: { speed: 1.0, freq: 2.5, amp: 0.12, base: 0.28 } },
              { id: 'sph_sg', type: 'sphereSDF3D', position: { x: 700, y: 200 },
                inputs: {
                  pos:    { type: 'vec3',  label: 'Position', connection: { nodeId: 'g3d_sg', outputKey: 'cellUV'      } },
                  radius: { type: 'float', label: 'Radius',   connection: { nodeId: 'wr_sg',  outputKey: 'wave_radius' } },
                },
                outputs: { dist: { type: 'float', label: 'Distance' } },
                params: { radius: 0.3 } },
            ],
      ...
      { id: 'g3dw_ray3', type: 'rayMarch', position: { x: 540, y: 180 },
        inputs: {
          scene: { type: 'scene3d', label: 'Scene', connection: { nodeId: 'g3dw_sc2', outputKey: 'scene' } },
        ...
        outputs: { color: { type: 'vec3', label: 'Color' }, depth: { type: 'float', label: 'Depth' }, normal: { type: 'vec3', label: 'Normal' } },
        params: { camDist: 4.5, fov: 1.2, maxSteps: 80, maxDist: 20.0, lightX: 2.0, lightY: 4.0, lightZ: 3.0, bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.9, albedoG: 0.6, albedoB: 0.4 } },
      { id: 'g3dw_out4', type: 'output', position: { x: 820, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3dw_ray3', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },

  // ── Grid 3D: Neighbor Dist ────────────────────────────────────────────────────
  // NeighborDist3D prevents SDF clipping when sphere radius pushes past cell boundary.
  // Uses waveRadius so clipping would be visible without NeighborDist3D.
  grid3dNeighbor: {
    label: 'Grid 3D: Neighbor Dist',
    counter: 5,
    nodes: [
      { id: 'g3dn_uv0', type: 'uv', position: { x: 60, y: 200 },
        inputs: {}, outputs: { uv: { type: 'vec2', label: 'UV' } }, params: {} },
      { id: 'g3dn_t1', type: 'time', position: { x: 60, y: 360 },
        inputs: {}, outputs: { time: { type: 'float', label: 'Time' } }, params: {} },
      { id: 'g3dn_sc2', type: 'sceneGroup', position: { x: 280, y: 220 },
        inputs: {},
        outputs: { scene: { type: 'scene3d', label: 'Scene' } },
        params: {
          label: 'Grid 3D Neighbor',
          subgraph: {
            nodes: [
              { id: 'sp_sg', type: 'scenePos', position: { x: 60, y: 200 },
                inputs: {}, outputs: { pos: { type: 'vec3', label: 'Position' } }, params: {} },
              { id: 'g3d_sg', type: 'grid3d', position: { x: 240, y: 200 },
                ...
                params: { columns: 5, uniform_scale: 1.0 } },
              { id: 'wr_sg', type: 'waveRadius', position: { x: 480, y: 340 },
                inputs: { distance: { type: 'float', label: 'Distance', connection: { nodeId: 'g3d_sg', outputKey: 'distToOrigin' } } },
                outputs: { wave_radius: { type: 'float', label: 'Wave Radius' } },
                params: { speed: 0.9, freq: 2.2, amp: 0.15, base: 0.22 } },
              { id: 'nd_sg', type: 'neighborDist3d', position: { x: 480, y: 180 },
                inputs: { cellUV: { type: 'vec3', label: 'Cell UV', connection: { nodeId: 'g3d_sg', outputKey: 'cellUV' } } },
                outputs: { minDist: { type: 'float', label: 'Min Dist' } },
                params: { neighborhood_size: 1 } },
              { id: 'sdf_sg', type: 'exprNode', position: { x: 700, y: 230 },
                inputs: {
                  d:  { type: 'float', label: 'd',  connection: { nodeId: 'nd_sg', outputKey: 'minDist'     } },
                  wr: { type: 'float', label: 'wr', connection: { nodeId: 'wr_sg', outputKey: 'wave_radius' } },
                },
                outputs: { result: { type: 'float', label: 'Result' } },
                params: {
      ...
      { id: 'g3dn_ray3', type: 'rayMarch', position: { x: 540, y: 180 },
        inputs: {
          scene: { type: 'scene3d', label: 'Scene', connection: { nodeId: 'g3dn_sc2', outputKey: 'scene' } },
        ...
        outputs: { color: { type: 'vec3', label: 'Color' }, depth: { type: 'float', label: 'Depth' }, normal: { type: 'vec3', label: 'Normal' } },
        params: { camDist: 4.5, fov: 1.2, maxSteps: 80, maxDist: 20.0, lightX: 2.0, lightY: 4.0, lightZ: 3.0, bgR: 0.02, bgG: 0.02, bgB: 0.05, albedoR: 0.4, albedoG: 0.75, albedoB: 0.5 } },
      { id: 'g3dn_out4', type: 'output', position: { x: 820, y: 200 },
        inputs: { color: { type: 'vec3', label: 'Color', connection: { nodeId: 'g3dn_ray3', outputKey: 'color' } } },
        outputs: {}, params: {} },
    ],
  },
